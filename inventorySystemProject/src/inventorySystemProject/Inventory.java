...
public class Inventory 
{
	...
	//Inventory has a counter for the row index to be used when storing the next item
	private int rowCounter = 0;
	
	//Inventory has a counter for the column index to be used when storing the next item
	...
	public Inventory()
	{
		...
		items = new Item[100][100];
	}
	
	//TODO implement shelves (better use of 2D array)
	...
	{	
		//Assigns index with item added
		items[rowCounter][columnCounter] = item;
		//Increments rowCounter for next added item
		++rowCounter;
		//Increments columnCounter for next added item
		++columnCounter;
	}
