 ...
 * 
 * Responsibilities of class: Starts the program by creating a new inventory. Used to communicate with the program.
 * 
 */
...
{
	/**
	 * Purpose: Test method for interacting with the program. Feel free to play around with it.
	 * @param args
	 */
